    ...
    <section className={styles.section} id="resume" aria-label="Resume">
      <Reveal>
        <div className={styles.head}>
          ...
          <p className={styles.sub}>One-page snapshot, plus a printable version. Last updated {resumeSnapshot.lastUpdated}.</p>
        ...
        <Reveal>
          <div className={styles.card}>
            <div className={styles.cardTop}>
              ...
              <div className={styles.mini}>
                GitHub:{" "}
                <a className={styles.link} href={resumeSnapshot.contact.githubUrl} target="_blank" rel="noreferrer">
