    ...
    <section className={styles.section} id="contact" aria-label="Contact">
      <Reveal>
        <div className={styles.head}>
          ...
          <p className={styles.sub}>If you want to collaborate on a web project, frontend build, or full-stack idea, send a note.</p>
        </div>
      </Reveal>
          ...
          <div className={styles.formCard}>
            ...
            {success ? (
              ...
              >
                ...
                <p className={styles.formMeta}>Send a quick note and I will get back to you by email.</p>
              </form>
            )}
          </div>
        </Reveal>
